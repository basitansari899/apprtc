...
class PeerConnectionClient {
  ...
  Future<void> createPeerConn(
    ...
    print(signalingParameters.iceServers.toString()+'uuuuuuuuuuuuuuuu');
...
//    peerConnection.removeCandidates(candidates);
  ...
  Future<void> _createPeerConnectionInternal() async {
    ...
    peerConnection.onAddStream = (stream) {
      print("Djjjjjjjjjjjjj $_ onAddStream: $stream");
      
      _remoteRenderer.srcObject = stream;
      print('lllllllllllll'+_remoteRenderer.renderVideo.toString()+'............................');
    };
